		...
		<div class="row">
		  ...
		  <!-- Message here (if exist) -->			
			...
			<div class="card">
			  ...
			  <div class="card-body">
				<form @submit.prevent="crearUsuario({nombre:nombre, lastname:lastname, username:username, email:email, password:password, role:role})">
				  <div class="row">
				  ...
				  <div class="row">
					...
					<div class="col-md-4 px-md-1">
					  <div class="form-group">
						...
						<input type="email" class="form-control" placeholder="email@email.com" v-model="email">
					  </div>
					</div>
				  ...
				  <div class="card-footer">
						<button type="submit" class="btn btn-fill btn-primary float-right">Registrar</button>
					</div>
				</form>
			  </div>
			</div>
